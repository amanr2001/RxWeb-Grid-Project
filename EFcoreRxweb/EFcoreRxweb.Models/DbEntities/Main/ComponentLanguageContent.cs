...
using EFcoreRxweb.Models.Enums.Main;
...
namespace EFcoreRxweb.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(EFcoreRxweb.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(EFcoreRxweb.Models.Main.LanguageContent.ComponentLanguageContents))]
